...
socket.on('connect', () => {
  ...
  // Simulate web user sending message
  const testUserId = 999888777; // Test web user ID
  const testBotId = 'mattyatlas';
  const testMessage = 'Hello Matty, this is a test message from web UI to verify session tracking works';
